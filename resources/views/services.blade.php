<x-layout>
    ...
    <div class="service-container">
        ...
        <div class="service-description">
            ...
            <p class="f-size-md f-weight-light mb-md">CarzCo provides a range of event services, including:</p>
            <ul class="f-size-md f-weight-light">
                <li><strong>Showstopping vehicle displays:</strong> Impress your guests with a curated selection of exotic and luxury vehicles at your next corporate event, wedding, or private party.</li>
