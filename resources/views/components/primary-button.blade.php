...
<button {{ $attributes->merge(['type' => 'submit', 'class' => 'inline-flex items-center '. $padding .' '. $colors .' border border-transparent rounded-md font-semibold text-md focus:outline-none focus:ring-2 focus:ring-indigo-500 transition ease-in-out duration-150']) }}>
    {{ $slot }}
</button>
